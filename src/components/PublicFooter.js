...
export default function PublicFooter() {
  ...
  useEffect(() => {
    axios
      .get("https://4g6q9fjz-5000.asse.devtunnels.ms/profile")
      .then((res) => {
  ...
  const socialLinks = [
    { name: "GitHub", icon: "code_blocks", href: profile?.github_link || "#", color: "hover:bg-slate-800 hover:border-slate-800" },
    { name: "LinkedIn", icon: "work_history", href: profile?.linkedin_link || "#", color: "hover:bg-blue-700 hover:border-blue-700" },
    { name: "Twitter", icon: "alternate_email", href: "#", color: "hover:bg-sky-500 hover:border-sky-500" }, // Bisa dihapus jika tidak ada twitter
    { name: "Instagram", icon: "photo_camera", href: profile?.instagram_link || "#", color: "hover:bg-pink-600 hover:border-pink-600" },
  ];
            ...
            <div className="lg:col-span-2">
              <Link href="/" className="inline-block mb-6 group">
                <div className="flex items-center gap-4">
                  <div className="relative w-14 h-14 bg-white rounded-xl shadow-lg border border-slate-100 flex items-center justify-center overflow-hidden transition-transform duration-300 group-hover:scale-105 group-hover:shadow-blue-200">
                    <Image
