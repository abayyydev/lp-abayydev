...
export default function SkillsManager() {
  ...
  const fetchSkills = () => {
    axios
      .get("https://ukmelrahma.my.id/portofolio-abayyy/skills")
  ...
  const handleAdd = async (e) => {
    ...
    try {
      await axios.post("https://ukmelrahma.my.id/portofolio-abayyy/skills", formData);
  ...
  const handleDelete = async (id) => {
    ...
    if (result.isConfirmed) {
      try {
        await axios.delete(`https://ukmelrahma.my.id/portofolio-abayyy/skills/${id}`);
        fetchSkills();
        Swal.fire({
          title: "Terhapus!",
